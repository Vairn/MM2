...
**Event 01** — triggers: (7,0)/ALWAYS, (8,0)/ALWAYS, (9,0)/ALWAYS
...
**Event 06** — triggers: (10,13)/ALWAYS
...
**Event 07** — triggers: (6,3)/DIR_SPECIAL
...
**Event 08** — triggers: (10,3)/DIR_SPECIAL
...
**Event 10** — triggers: (8,1)/DIR_SPECIAL
