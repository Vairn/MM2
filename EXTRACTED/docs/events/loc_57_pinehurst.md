...
| (5,10) | `0x5A` | **8** | ALWAYS |
| (5,11) | `0x5B` | **6** | DIR_N? |
| (5,12) | `0x5C` | **5** | DIR_SPECIAL |
| (5,14) | `0x5E` | **21** | DIR_N? |
| (6,2) | `0x62` | **20** | ANY_DIR |
| (6,7) | `0x67` | **22** | DIR_N? |
| (6,10) | `0x6A` | **7** | ALWAYS |
| (6,12) | `0x6C` | **4** | DIR_SPECIAL |
| (7,2) | `0x72` | **26** | 0xA0 |
| (7,10) | `0x7A` | **5** | ALWAYS |
| (7,12) | `0x7C` | **15** | ALWAYS |
| (7,13) | `0x7D` | **2** | ALWAYS |
| (7,15) | `0x7F` | **17** | DIR_SPECIAL |
| (8,2) | `0x82` | **28** | ANY_DIR |
| (8,10) | `0x8A` | **9** | ALWAYS |
| (8,12) | `0x8C` | **15** | ALWAYS |
| (8,13) | `0x8D` | **3** | ALWAYS |
| (8,15) | `0x8F` | **17** | DIR_SPECIAL |
| (9,10) | `0x9A` | **10** | ALWAYS |
| (9,12) | `0x9C` | **14** | DIR_SPECIAL |
| (10,10) | `0xAA` | **11** | ALWAYS |
| (10,11) | `0xAB` | **12** | ENTER |
| (10,12) | `0xAC` | **13** | DIR_SPECIAL |
| (10,14) | `0xAE` | **25** | ENTER |

## Events

**Event 01** — triggers: (2,13)/ENTER
...
**Event 04** — triggers: (6,12)/DIR_SPECIAL
...
**Event 05** — triggers: (5,12)/DIR_SPECIAL, (7,10)/ALWAYS
...
**Event 11** — triggers: (10,10)/ALWAYS
...
**Event 13** — triggers: (10,12)/DIR_SPECIAL
...
**Event 14** — triggers: (9,12)/DIR_SPECIAL
...
**Event 15** — triggers: (7,12)/ALWAYS, (8,12)/ALWAYS
...
**Event 17** — triggers: (7,15)/DIR_SPECIAL, (8,15)/DIR_SPECIAL
...
**Event 26** — triggers: (0,2)/DIR_SPECIAL, (7,2)/0xA0
