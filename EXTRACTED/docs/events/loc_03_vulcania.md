...
| (8,11) | `0x8B` | **14** | ALWAYS |
| (8,13) | `0x8D` | **9** | ALWAYS |
| (8,14) | `0x8E` | **2** | DIR_SPECIAL |
| (8,15) | `0x8F` | **13** | DIR_SPECIAL |
| (9,3) | `0x93` | **28** | DIR_N? |
| (9,6) | `0x96` | **30** | 0x30 |
| (9,8) | `0x98` | **33** | 0x60 |
| (10,3) | `0xA3` | **11** | DIR_N? |
| (11,6) | `0xB6` | **31** | 0x90 |
| (11,8) | `0xB8` | **32** | ENTER+SPECIAL |
| (12,3) | `0xC3` | **35** | ANY_DIR |
| (12,7) | `0xC7` | **25** | ENTER |
| (12,10) | `0xCA` | **26** | ALWAYS |
...
**Event 02** — triggers: (8,14)/DIR_SPECIAL
...
**Event 13** — triggers: (8,15)/DIR_SPECIAL
...
**Event 26** — triggers: (12,10)/ALWAYS
...
**Event 32** — triggers: (11,8)/ENTER+SPECIAL
