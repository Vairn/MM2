...
| (14,15) | `0xEF` | **3** | ENTER |
| (15,8) | `0xF8` | **1** | ENTER |
| (15,15) | `0xFF` | **2** | DIR_SPECIAL |

## Events

**Event 01** — triggers: (15,8)/ENTER
...
**Event 02** — triggers: (15,15)/DIR_SPECIAL
...
**Event 07** — triggers: (5,7)/DIR_N?, (5,9)/DIR_N?, (7,6)/ALWAYS, (7,10)/DIR_SPECIAL
...
**Event 10** — triggers: (1,5)/DIR_SPECIAL
