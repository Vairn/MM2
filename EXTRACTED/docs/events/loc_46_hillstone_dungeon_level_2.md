...
| (15,1) | `0xF1` | **9** | ANY_DIR |
| (15,9) | `0xF9` | **4** | DIR_N? |
| (15,15) | `0xFF` | **2** | DIR_N?+DIR_E? |

## Events

**Event 01** — triggers: (12,0)/DIR_W?
...
**Event 02** — triggers: (15,15)/DIR_N?+DIR_E?
