...
| (6,14) | `0x6E` | **10** | DIR_N? |
| (7,7) | `0x77` | **23** | ENTER |
| (7,9) | `0x79` | **5** | DIR_SPECIAL |
| (7,10) | `0x7A` | **26** | DIR_SPECIAL |
| (8,1) | `0x81` | **16** | ALWAYS |
| (8,2) | `0x82` | **11** | ALWAYS |
| (8,13) | `0x8D` | **28** | DIR_SPECIAL |
| (8,14) | `0x8E` | **36** | DIR_SPECIAL |
| (9,1) | `0x91` | **35** | ALWAYS |
| (9,2) | `0x92` | **14** | ALWAYS |
| (10,12) | `0xAC` | **32** | DIR_N? |
| (11,12) | `0xBC` | **15** | DIR_N? |
| (12,1) | `0xC1` | **19** | ALWAYS |
| (12,2) | `0xC2` | **13** | DIR_SPECIAL |
| (12,3) | `0xC3` | **34** | DIR_SPECIAL |
...
| (15,1) | `0xF1` | **12** | ALWAYS |
| (15,5) | `0xF5` | **20** | ENTER |
| (15,15) | `0xFF` | **17** | ENTER+SPECIAL |

## Events

**Event 01** — triggers: (5,7)/DIR_N?
...
**Event 05** — triggers: (7,9)/DIR_SPECIAL
...
**Event 13** — triggers: (12,2)/DIR_SPECIAL
...
**Event 17** — triggers: (15,15)/ENTER+SPECIAL
...
**Event 26** — triggers: (7,10)/DIR_SPECIAL
...
**Event 28** — triggers: (8,13)/DIR_SPECIAL
...
**Event 34** — triggers: (12,3)/DIR_SPECIAL
...
**Event 36** — triggers: (8,14)/DIR_SPECIAL
