...
| (3,14) | `0x3E` | **14** | 0xA0 |
| (3,15) | `0x3F` | **14** | 0xA0 |
| (5,7) | `0x57` | **14** | DIR_SPECIAL |
| (5,13) | `0x5D` | **3** | DIR_N? |
| (6,13) | `0x6D` | **16** | 0x50 |
| (7,7) | `0x77` | **14** | DIR_SPECIAL |
| (8,0) | `0x80` | **14** | 0xA0 |
| (8,1) | `0x81` | **14** | ENTER |
| (8,2) | `0x82` | **14** | DIR_N? |
| (8,3) | `0x83` | **14** | ENTER |
...
| (8,10) | `0x8A` | **11** | ALWAYS |
| (8,13) | `0x8D` | **16** | 0x50 |
| (9,7) | `0x97` | **12** | DIR_SPECIAL |
| (9,11) | `0x9B` | **1** | ENTER+SPECIAL |
| (10,0) | `0xA0` | **8** | ANY_DIR |
| (10,1) | `0xA1` | **12** | ALWAYS |
| (11,7) | `0xB7` | **12** | DIR_SPECIAL |
| (11,8) | `0xB8` | **8** | ANY_DIR |
| (11,13) | `0xBD` | **16** | 0x50 |
| (12,0) | `0xC0` | **16** | DIR_N? |
| (12,1) | `0xC1` | **15** | ENTER |
...
| (12,6) | `0xC6` | **15** | DIR_N? |
| (12,13) | `0xCD` | **13** | ENTER |
| (13,7) | `0xD7` | **15** | DIR_SPECIAL |
| (13,13) | `0xDD` | **16** | DIR_SPECIAL |
| (14,10) | `0xEA` | **11** | DIR_SPECIAL |
| (14,11) | `0xEB` | **7** | DIR_SPECIAL |
| (14,13) | `0xED` | **16** | ALWAYS |
| (15,0) | `0xF0` | **4** | ALWAYS |
| (15,2) | `0xF2` | **9** | ALWAYS |
| (15,7) | `0xF7` | **15** | 0x50 |
| (15,10) | `0xFA` | **8** | ANY_DIR |
| (15,13) | `0xFD` | **16** | DIR_SPECIAL |

## Events

**Event 01** — triggers: (9,11)/ENTER+SPECIAL
...
**Event 02** — triggers: (0,15)/DIR_SPECIAL
...
**Event 07** — triggers: (14,11)/DIR_SPECIAL
...
**Event 11** — triggers: (8,10)/ALWAYS, (14,10)/DIR_SPECIAL
...
**Event 12** — triggers: (1,2)/DIR_N?, (9,7)/DIR_SPECIAL, (10,1)/ALWAYS, (11,7)/DIR_SPECIAL
...
**Event 13** — triggers: (3,2)/DIR_N?, (12,2)/ENTER, (12,13)/ENTER
...
**Event 14** — triggers: (3,8)/DIR_N?, (3,9)/DIR_N?, (3,10)/0xA0, (3,11)/0xA0, (3,12)/0xA0, (3,13)/0xA0, (3,14)/0xA0, (3,15)/0xA0, (5,7)/DIR_SPECIAL, (7,7)/DIR_SPECIAL, (8,0)/0xA0, (8,1)/ENTER, (8,2)/DIR_N?, (8,3)/ENTER, (8,4)/DIR_N?, (8,5)/ENTER, (8,6)/DIR_N?
...
**Event 15** — triggers: (3,0)/DIR_N?, (3,4)/0xA0, (3,6)/0xA0, (12,1)/ENTER, (12,3)/ENTER, (12,4)/DIR_N?, (12,5)/ENTER, (12,6)/DIR_N?, (13,7)/DIR_SPECIAL, (15,7)/0x50
...
**Event 16** — triggers: (0,7)/ALWAYS, (6,13)/0x50, (8,13)/0x50, (11,13)/0x50, (12,0)/DIR_N?, (13,13)/DIR_SPECIAL, (14,13)/ALWAYS, (15,13)/DIR_SPECIAL
