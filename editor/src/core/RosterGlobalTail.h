...
constexpr int kOp0eFdCtr = 0x03E;      // u16 -> A4-$7972
constexpr int kBattlesWon = 0x040;     // u16 -> A4-$7970 (0x1215A)
constexpr int kBattlesLost = 0x042;    // u16 -> A4-$796E (0x11664)
constexpr int kAutomap = 0x044;        // $780 bytes -> A4-$4F4C (60×16 LE row-words)
...
constexpr int kSavedTownId = 0x7EF;    // -$79AC inn Goto Town
