                                       ...
                                       const SheetSession *session) const
{
    ...
    /* book.32 @ row 18 overlaps footer rows — clear before command text. */
    gfx::fillCellRect(c, kSheetFooterCol, kSheetFooterRow1 - 1, kPlayOverlayBorderW - 2, 3);
    ...
    drawCellText(c, kSheetFooterRow2, kSheetFooterCol + 19, "'S' Share  'T' Trade  'U' Use", 180, 180, 180);
